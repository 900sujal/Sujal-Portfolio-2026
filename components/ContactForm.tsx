...
export function ContactForm() {
  ...
  return (
    <motion.form initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} onSubmit={handleSubmit} className="grid gap-5 rounded-3xl border border-white/10 bg-slate-900/70 p-8 shadow-glow">
